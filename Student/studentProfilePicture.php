...
if(isset($_POST['submit'])){
  ...
  $sql = "UPDATE users SET profilePicture='$fileName' WHERE username='$username'";
    ...
    if(mysqli_query($conn, $sql)){
      ...
      header("Location:studentProfilePicture.php");
      echo "success";
      die();
    } else{
   ...
   <body>
       ...
       <table border="0" width="100%">
         <tbody>
           <tr width="100%">
             ...
             <td align="center"><font size="5"><b>Change Profile Picture</b></font></td>
           </tr>
         </tbody>
       </table>
       <table border="0" width="100%">
     ...
     <div class="main_home">
       <table border="1" width="100%">
         <tbody>
           <tr bgcolor="F6E5F5">
             <form class="" action="studentProfilePicture.php" method="post" enctype="multipart/form-data">
