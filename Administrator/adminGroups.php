<?php
   ...
   $query = "SELECT class_group.group_id,student.birth_date,student.phone,class_group.group_name,class_group.leader_id,class_group.course_id, stud_in_group.student_id,student.first_name, student.last_name, users.email
           FROM class_group
    ...
    <table border="0" width="100%">
      <tbody>
        <tr width="100%">
          ...
          <td align="center"><font size="5"><b>Course Groups</b></font></td>
        </tr>
      </tbody>
    </table>
    <table border="0" width="100%">
