...
class __TwigTemplate_99a8e5b38e63d6a582d17db59a923f24 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Edit next row");
    ...
    <tr>
      ...
      <td colspan=\"3\" class=\"text-end align-middle\">
        <input type=\"button\" class=\"btn btn-secondary preview_sql\" value=\"";
...
";
    ...
    {
        return new Source("", "table/insert/actions_panel.twig", "/Users/maureenadelson/Sites/phpMyAdmin/templates/table/insert/actions_panel.twig");
    }
}
