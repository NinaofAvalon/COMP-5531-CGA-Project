...
class __TwigTemplate_8cce442f2a56017a4b83bfb0bcc7a859 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/Users/maureenadelson/Sites/phpMyAdmin/templates/preferences/header.twig");
    }
}
