...
class __TwigTemplate_b6a3fdbbf14705fbf61b108f240f68c1 extends Template
{
    private $source;
    private $macros = [];
  ...
  <td class=\"text-center\">
    ";
        // line 3
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "Field_title", [], "any", false, false, false, 3), "html", null, true);
        echo "
    <input type=\"hidden\" name=\"fields_name[multi_edit][";
        ...
        echo "]\" value=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "Field_html", [], "any", false, false, false, 4), "html", null, true);
        echo "\">
  </td>
...
";
    ...
    {
        return new Source("", "table/insert/column_row.twig", "/Users/maureenadelson/Sites/phpMyAdmin/templates/table/insert/column_row.twig");
    }
}
