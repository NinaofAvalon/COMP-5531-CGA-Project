...
$ses_sql = mysqli_query($conn,"select emails.id as email_id, users.username as username, emails.email_subject, emails.email_body, r.username as recipient, emails.email_date from emails join users on emails.sender = users.id join users r on r.id = emails.recipient where sender = '$user_check' ");
      ...
      <table border="0" width="100%">
        <tbody>
          <tr width="100%">
            ...
            <td align="center"><font size="5"><b>Email Sent</b></font></td>
          </tr>
        </tbody>
      </table>
      <table border="0" width="100%">
