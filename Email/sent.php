...
$ses_sql = mysqli_query($conn,"select users.username as username, emails.email_subject, emails.email_body, r.username as recipient from emails join users on emails.sender = users.id join users r on r.id = emails.recipient where sender = '$user_check' ");
